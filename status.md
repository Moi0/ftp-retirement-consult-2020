...
(last updated per [this message](https://mailarchive.ietf.org/arch/msg/ietf/_Mn7kSPur7OOiFRBDgx8cyh1CJE/) in the main thread; 2020-12-07)

(last updated per [this message](https://mailarchive.ietf.org/arch/msg/ietf/HB1IfSO_PkIA2nGDvNRNHAU_Peo/) in a side thread; 2020-12-03)
...
The following are pointers to explicitly stated positions (and rationales) on the retirement plan.  No assumptions were made about the positions of parties who asked or endorsed a question, described a personal workflow, provided technical analysis/opinion, etc.  See [[190]](https://mailarchive.ietf.org/arch/msg/ietf/GXzI5CRCVLhfKzFR4s5BwKmjhio/).  There were significantly more contributors to the mailing list discussion than suggested by the pointers to the positions noted below. 

### Oppose: 
* [[Ohta]](https://mailarchive.ietf.org/arch/msg/ietf/7Itgz5txNUZATpc5SKRwKLLc-hs/) [[Eckert]](https://mailarchive.ietf.org/arch/msg/ietf/XFJOyi9a8KsrF4vmBAghb0Zo3mo/) 
 [[Mauch]](https://mailarchive.ietf.org/arch/msg/ietf/Nydu9WAV7OOUDbXTNB6rkH8IIfM/) [[Ned]](https://mailarchive.ietf.org/arch/msg/ietf/RXzbxmpS0kTlbv0iDZNt9vvMMbs/) [[Kulawiec]](https://mailarchive.ietf.org/arch/msg/ietf/j0vrAvb_baoo11tdET5romkRi8c/) [Klensin -[position](https://mailarchive.ietf.org/arch/msg/ietf/k5AUm-1JXNp0wmFldIiQSGzg1Ck/) -[contingency](https://mailarchive.ietf.org/arch/msg/ietf/yPBgIYbnGeNOfpA-C3f1Gojes-o/)] [[Nerenberg]](https://mailarchive.ietf.org/arch/msg/ietf/uaCQP0VPcLWzDe7hRkLiFAx4MLU/)
...
### IETF should not force participants into a particular workflow around tooling [[1011]](https://mailarchive.ietf.org/arch/msg/ietf/gtYGXyqVonTyK8ZH8V2b3weHM30/) [[189]](https://mailarchive.ietf.org/arch/msg/ietf/k5AUm-1JXNp0wmFldIiQSGzg1Ck/)
* Supporting all work flows indefinitely leads to stagnation [[292]](https://mailarchive.ietf.org/arch/msg/ietf/fv6zXzuXaquNV-4FgfOosKk2HUE/)
...
* ... various discussion on who should (and when) incur the cost of the service -- technical debt [[197]](https://mailarchive.ietf.org/arch/msg/ietf/L9B1Cp_82cyu5LmUZxEF-gjEdnc/) [[204]](https://mailarchive.ietf.org/arch/msg/ietf/BP3OuI9YXn_5ZnOrPxT_OyTuNFw/), fixed resources [[205]], different tolerance for changing worklow [[292]](https://mailarchive.ietf.org/arch/msg/ietf/fv6zXzuXaquNV-4FgfOosKk2HUE/) ...
...
### Browsers do not return documents in the correct formats or 'as the author intended' [[246]](https://mailarchive.ietf.org/arch/msg/ietf/Rx_cNAMc-oGo4HB2GUwUiR86cuc/) and "are in constant state of flux" for a reliable download client [[277]](https://mailarchive.ietf.org/arch/msg/ietf/kbIHB0IKQPuWRC6RCNItBu2-H1s/)
...
Irrespective of this proposal, FTP access to RFCs and I-Ds will continue at ftp.rfc-editor.org [[207]](https://mailarchive.ietf.org/arch/msg/ietf/4WLRpcsDM-P6zxrQOz6Ud1tvU98/).  The rfc-editor is the authoritative source for RFCs.
...
### FTP provides alternative access mechanism [[101]](https://mailarchive.ietf.org/arch/msg/ietf/j0vrAvb_baoo11tdET5romkRi8c/) [[230]](https://mailarchive.ietf.org/arch/msg/ietf/MRh_19FpAxpSd1konaz_gXZ4X6k/)
...
* Additional access mechanism have cost [[231]](https://mailarchive.ietf.org/arch/msg/ietf/m0JuS-cQE1az_UF5uqUmwkzJtU0/)

### FTP is simple tool [[301]](https://mailarchive.ietf.org/arch/msg/ietf/vBtljQ8jo9rEFQFg8-zxLx3Y4co/)
...
* rsync is availible on Unix, Mac, Windows and NetBSD [[33]](https://mailarchive.ietf.org/arch/msg/ietf/CxhHhd1jWNFSIdV50bmJKMiZfPw/) [[324]](https://mailarchive.ietf.org/arch/msg/ietf/8YdZWg9ltetgfDB7j1BXRYVkoJs/)
* Three rsync servers exist for community use [[60]](https://mailarchive.ietf.org/arch/msg/ietf/SA0IK0dPPujWMOMFvOquwstGb34/)

#### Rsync is not is not standardized [[234]](https://mailarchive.ietf.org/arch/msg/ietf/1VIdoo0NYsKhpoGDpG3cLnP5x-0/)
